...
class RegisterView: UIView, UITextFieldDelegate {
    ...
    override init(frame: CGRect) {
        ...
        nicknameTextField.addTarget(nil,
        ...
        repeatPasswordTextField.addTarget(nil,
                                          action: #selector(WelcomeViewTFListener.textFieldDidChange),
                                          for: .editingChanged)
...
extension RegisterView {
    ...
    private func configureLayoutElements() {
        ...
        addSubviews([greetingLabel, greetingDescriptionLabel, materialBackground,
                     firstDivider, secondDivider, thirdDivider, createAccountButton])
        ...
        createAccountButton.addTarget(nil,
                                      action: #selector(RegisterViewActionHandler.createAccount),
                                      for: .touchUpInside)

        if isLightMode {
            createAccountButton.addShadowToView(shadowColor: WColors.purple!,
...
extension RegisterView {
    ...
    func resetViewsForNewInterfaceStyle(_ previousTraitCollection: UITraitCollection?) {
        ...
        case .light:
            createAccountButton.addShadowToView(shadowColor: .clear,
